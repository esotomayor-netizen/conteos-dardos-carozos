...
CRM de captación (`/productores`, `/agronomos`):
- **agronomos**: equipo comercial/agronómico que hace la captación.
- **productores**: razón social, dueño/administrador y sus contactos, ubicación (región/provincia/comuna/dirección), código SAG y agrónomo asignado.
...
6. Abre [http://localhost:3000](http://localhost:3000). El listado de productores está en `/productores` y el equipo de agrónomos en `/agronomos`.
